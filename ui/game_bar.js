...
export default class GameBar {
  ...
  draw() {
    ...
    this.board.game.ctx.fillText('Đợt quái số : '+ this.board.currentWay + "/" + this.board.enemyWays.length , Const.GOUND_SIZE * 5, Const.GAME_HEIGHT + 23);
    this.board.game.ctx.fillText('Số quái : '+ this.board.waitToSpawnEnemies + "/" + this.board.enemyOfCurrentWay , Const.GOUND_SIZE * 5, Const.GAME_HEIGHT + 48);
